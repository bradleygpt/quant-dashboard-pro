...
# Configuration
RESULTS_FILE = "quant_variants_results.json"
...
def score_universe_at_date(checkpoint_date, universe):
    ...
    # Use the new PIT scoring (matches dashboard)
...
def main():
    ...
    print(f"Backtesting {len(checkpoint_dates)} quarterly checkpoints", flush=True)
    if LOCAL_RUN:

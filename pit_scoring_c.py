...
PIT_PILLAR_METRICS = {
    ...
    # Version C: 4-pillar scoring. The dashboard's "EPS Revisions" pillar requires
    # paid analyst data unavailable historically, so we drop it. Composite is
    # weighted average of remaining 4 pillars.
}
